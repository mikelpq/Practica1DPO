import Settings.EnvironmentKeys;
...
public class ServerRequest {
    ...
    /** REQUEST OPCIO 3 **/
    public static ResponseJson createRouteRequest(String name_src, String name_dst, String arrive, String date, String time, String distancia) {
        OkHttpClient client = new OkHttpClient();
        ...
        urlBuilder.addQueryParameter("mode", "WALK, TRANSIT");
